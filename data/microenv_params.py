...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        self.oxygen_diffusion_coefficient = FloatText(value=0,
        ...
        self.oxygen_decay_rate = FloatText(value=0,
          step=0.01,style=style, layout=widget_layout)
        ...
        self.glucose_diffusion_coefficient = FloatText(value=0,
          step=0.01,style=style, layout=widget_layout)

        param_name6 = Button(description='decay_rate', disabled=True, layout=name_button_layout)

        self.glucose_decay_rate = FloatText(value=0,
          step=0.01,style=style, layout=widget_layout)
        param_name7 = Button(description='initial_condition', disabled=True, layout=name_button_layout)

        self.glucose_initial_condition = FloatText(value=13,style=style, layout=widget_layout)
        param_name8 = Button(description='Dirichlet_boundary_condition', disabled=True, layout=name_button_layout)

        self.glucose_Dirichlet_boundary_condition = FloatText(value=13,style=style, layout=widget_layout)
        ...
        menv_var3 = Button(description='energy', disabled=True, layout=name_button_layout)
        ...
        self.energy_diffusion_coefficient = FloatText(value=0,
          step=0.01,style=style, layout=widget_layout)

        param_name10 = Button(description='decay_rate', disabled=True, layout=name_button_layout)

        self.energy_decay_rate = FloatText(value=0,
          step=0.01,style=style, layout=widget_layout)
        param_name11 = Button(description='initial_condition', disabled=True, layout=name_button_layout)

        self.energy_initial_condition = FloatText(value=0,style=style, layout=widget_layout)
        param_name12 = Button(description='Dirichlet_boundary_condition', disabled=True, layout=name_button_layout)

        self.energy_Dirichlet_boundary_condition = FloatText(value=0,style=style, layout=widget_layout)
        self.energy_Dirichlet_boundary_condition_toggle = Checkbox(description='on/off', disabled=False,style=style, layout=widget_layout)
        ...
        row_energy = [menv_var3,  ] 
        row9 = [param_name9, self.energy_diffusion_coefficient, menv_units_button9]
        row10 = [param_name10, self.energy_decay_rate, menv_units_button10]
        row11 = [param_name11, self.energy_initial_condition, menv_units_button11]
        row12 = [param_name12, self.energy_Dirichlet_boundary_condition, menv_units_button12, self.energy_Dirichlet_boundary_condition_toggle]
        ...
        box_energy = Box(children=row_energy, layout=box_layout)
    ...
    def fill_gui(self, xml_root):
        ...
        self.energy_diffusion_coefficient.value = float(vp[2].find('.//diffusion_coefficient').text)
        self.energy_decay_rate.value = float(vp[2].find('.//decay_rate').text)
        self.energy_initial_condition.value = float(vp[2].find('.//initial_condition').text)
        self.energy_Dirichlet_boundary_condition.value = float(vp[2].find('.//Dirichlet_boundary_condition').text)
        if vp[2].find('.//Dirichlet_boundary_condition').attrib['enabled'].lower() == 'true':
          self.energy_Dirichlet_boundary_condition_toggle.value = True
        else:
          self.energy_Dirichlet_boundary_condition_toggle.value = False
    ...
    def fill_xml(self, xml_root):
        ...
        vp[2].find('.//diffusion_coefficient').text = str(self.energy_diffusion_coefficient.value)
        vp[2].find('.//decay_rate').text = str(self.energy_decay_rate.value)
        vp[2].find('.//initial_condition').text = str(self.energy_initial_condition.value)
        vp[2].find('.//Dirichlet_boundary_condition').text = str(self.energy_Dirichlet_boundary_condition.value)
        vp[2].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.energy_Dirichlet_boundary_condition_toggle.value).lower()
